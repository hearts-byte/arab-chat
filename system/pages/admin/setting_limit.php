		...
		<div id="limtab">
			<div id="limit_profile" class="tab_zone">
				<div class="form_content">
					...
					<div class="setting_element">
						<p class="label"><?php echo $lang['allow_pmusic']; ?></p>
						<select id="set_allow_pmusic">
							<?php echo listRankMember($setting['allow_pmusic']); ?>
						</select>
					</div>
					<div class="setting_element">
			...
			<div id="limit_display" class="hide_zone tab_zone">
				<div class="form_content">
					...
					<?php if(!useBubble()){ ?>
					<div class="setting_element">
						<p class="label"><?php echo $lang['allow_tcolors']; ?></p>
						<select id="set_allow_colors">
							<?php echo listRank($setting['allow_colors']); ?>
						</select>
					</div>
					<div class="setting_element">
						<p class="label"><?php echo $lang['allow_tgrad']; ?></p>
						<select id="set_allow_grad">
							<?php echo listRank($setting['allow_grad']); ?>
						</select>
					</div>
					<div class="setting_element">
						<p class="label"><?php echo $lang['allow_tneon']; ?></p>
						<select id="set_allow_neon">
							<?php echo listRank($setting['allow_neon']); ?>
						</select>
					</div>
