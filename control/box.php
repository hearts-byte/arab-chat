...
<audio class="hidden" id="wall_sound" src="sounds/new_wall.mp3<?php echo $bbfv; ?>"></audio>
...
<audio class="hidden" id="top_sound" src="sounds/top_notify.mp3<?php echo $bbfv; ?>"></audio>
<?php } ?>