...
$settings_write .= "\$setting['boom'] = 'nulledbyHELLMEGADETH';\r\n";
...
fclose($settings_file);
	...
	$mysqli->query("INSERT INTO `boom_setting` (id, title, domain, language, default_theme, system_id, boom) VALUES (1, '" . $title . "', '" . $domain . "', '" . $language . "', 'Dark', 2, 'nulledbyHELLMEGADETH')");
